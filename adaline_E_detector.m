...
for i=1:length(alpha)
    alpha_new = alpha(i);
    [Wlast, blast, MSE, LastMSE] = adaline_train(initial_weights, initial_bias, alpha_new, training_set , targets_e,num_epochs);
    W_matrix(:,i) = Wlast;
    b_matrix(:,i) = blast;
...
Wlast_e = W_matrix(:,2)';
blast_e = b_matrix(:,2)';
predictions_e1 = adaline_predictions(test_set1,Wlast_e,blast_e);
