...
% by calling function percep1p repeatedly
...
for pt = 1:cp
    ...
    thisp = P(:,pt);
    thist = T(:,pt);
    % CALL percep1p for thisp and thist
    [Wnew, bnew] = percep1p(Wold, bold, thisp, thist);
    % INCREMENT nze ONLY IF NO CHANGES TOOK PLACE
